...
static void LoadBlock (LoadState* S, void* b, lua_Size size)
{
 if (S->swap)
 {
...
static void LoadVector (LoadState* S, void* b, int m, lua_Size size)
{
 if (S->swap)
 {
  char* q=(char*) b;
...
static lua_Size LoadSize (LoadState* S)
{
 lua_Size x;
 LoadBlock(S,&x,sizeof(x));
 return x;
...
static void LoadHeader (LoadState* S)
{
 ...
 //TESTSIZE(sizeof(size_t), "size_t"); // mzhk
 TESTSIZE(sizeof(lua_Size), "size_t");
