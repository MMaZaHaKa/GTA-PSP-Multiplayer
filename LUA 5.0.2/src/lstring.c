...
static TString *newlstr (lua_State *L, const char *str, lua_Size l, lu_hash h) {
...
TString *luaS_newlstr (lua_State *L, const char *str, lua_Size l) {
  GCObject *o;
  lu_hash h = (lu_hash)l;  /* seed */
  lua_Size step = (l>>5)+1;  /* if string is too long, don't hash all its chars */
  lua_Size l1;
...
Udata *luaS_newudata (lua_State *L, lua_Size s) {
  Udata *u;
