...
LUALIB_API const char *luaL_checklstring (lua_State *L, int numArg, lua_Size *l);
LUALIB_API const char *luaL_optlstring (lua_State *L, int numArg,
                                           const char *def, lua_Size *l);
...
LUALIB_API int luaL_loadbuffer (lua_State *L, const char *buff, lua_Size sz,
                                const char *name);
...
LUALIB_API int   lua_dobuffer (lua_State *L, const char *buff, lua_Size sz,
                               const char *n);
